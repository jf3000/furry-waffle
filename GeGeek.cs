...
using GeGeek.Forms;
using GeGeek.License;
using GeGeek.Properties;
...
namespace GeGeek
{
    public partial class MainForm : PersistentForm
    {
        ...
        private void m_Updater_UpdateCompleted(object sender, EventArgs e)
        {
            ...
            ntiTrayIcon.Text = "GeGeek (Idle)";
            ntiTrayIcon.ShowBalloonTip(5000, "Done", "GeGeek has finished the update check.", ToolTipIcon.Info);
        }
        ...
        private void mnuTutorial_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start("http://wiki.GeGeek.org/index.php/Basics");
            }
            catch (Exception)
            {
            }
