...
{
    /// <summary>
    /// The modified WebClient used by GeGeek for 
    ...
    internal class WebClient : System.Net.WebClient
    {
        ...
        {
            get { return defaultUserAgent ?? (defaultUserAgent = Settings.GetValue("DefaultUserAgent", "Mozilla/4.0 (compatible; GeGeek; +https://GeGeek.org/)") as string); }
        ...
        /// This won't work properly in GeGeek's context, but looks like missing protocols
