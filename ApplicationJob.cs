...
namespace GeGeek
{
    ...
    /// It is the main object of GeGeek.
    /// </summary>
    ...
    public class ApplicationJob
    {
        ...
        /// If true, only the information in database will be compared, and GeGeek
                    ...
                    using (IDbCommand command = DbManager.Connection.CreateCommand())
                    {
                        ...
                        using (IDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                {
                                    XmlSerializer serializer = new XmlSerializer(Type.GetType("GeGeek." + doc.DocumentElement.Name));
